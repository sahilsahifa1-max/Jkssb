        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-10 gap-4">
          <div>
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mt-1 max-w-xl">
              All question papers neatly structured across 5 primary examination disciplines from 2020 through 2026.
            </p>
          </div>
            ...
            >
              ...
              <div className="mt-6 pt-3 flex items-center justify-between gap-2">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium text-slate-600 dark:text-slate-300 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors"
                  title={`Open official ${sub.name} Google Drive repository`}
                >
